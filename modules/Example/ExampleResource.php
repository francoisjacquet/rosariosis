...
$columns = array('TITLE'=>_('Title'), 'STUDENT_NB'=>_('# of Students'), 'ADMIN_NB'=>_('# of Administrators'), 'TEACHER_NB'=>_('# of Teachers'), 'PARENT_NB'=>_('# of Parents'));

//display secondary header with text (aligned left)
DrawHeader('This is the Resources program from the Example module. The program is the same but the source contains comments.');
