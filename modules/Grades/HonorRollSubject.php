...
//modif Francois: add TinyMCE to the textarea
		$extra['extra_header_left'] .= '<TR><TD style="text-align:right; vertical-align: top;">'._('Text').'</TD><TD colspan="2"><TEXTAREA cols="97" rows="27" name="honor_roll_text" class="tinymce">';
		//modif Francois: add Template
		...
		$extra['extra_header_left'] .= '</TR><TR>';
		$extra['extra_header_left'] .= '<TD>&nbsp;</TD><TD>__SUBJECT__ = '._('Subject').'</TD>';
		$extra['extra_header_left'] .= '<TD>__CLIPART__ = '._('ClipArt').'</TD>';
...
//modif Francois: add frames choice
		...
		$extra['extra_header_left'] .= '</tr></table></DIV></TD></TR><TR><TD>&nbsp;</TD></TR>';
...
//modif Francois: add clipart choice
		...
		$extra['extra_header_left'] .= '<TR><TD style="text-align:right; vertical-align:top;">'._('ClipArt').'</TD><TD colspan="2"><div style="overflow-x:auto; height:160px;"><table class="cellpadding-0 cellspacing-0"><tr><td class="image-radio-list"><label class="image-radio-list"><INPUT type="radio" name="clipart" value="" checked /> '._('No ClipArt').'</label></td>';
		//create radio list with thumbnails
		$i = 1;
