...
//modif Francois: add <label> on checkbox
	...
	$toEscape = str_replace(array("'",'"'),array('&#39;','&quot;'),$course_title).'<BR /><label><INPUT type="checkbox" name="not_request_course" value="Y">'.str_replace(array("'",'"'),array('&#39;','&quot;'),_('Not Requested')).'</label>';
