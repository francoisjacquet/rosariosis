...
//modif Francois: multiple school periods for a course period
			// ROLL COURSE_PERIODS_SCHOOL_PERIODS
			DBQuery("INSERT INTO COURSE_PERIODS_SCHOOL_PERIODS (COURSE_PERIODS_SCHOOL_PERIODS_ID,COURSE_PERIOD_ID,PERIOD_ID,DAYS) SELECT ".db_seq_nextval('COURSE_PERIODS_SCHOOL_PERIODS_SEQ').",(SELECT COURSE_PERIOD_ID FROM course_periods cp WHERE cpsp.COURSE_PERIOD_ID=cp.ROLLOVER_ID),(SELECT PERIOD_ID FROM SCHOOL_PERIODS n WHERE AND n.ROLLOVER_ID=cpsp.PERIOD_ID),DAYS FROM COURSE_PERIODS_SCHOOL_PERIODS cpsp WHERE SYEAR='".UserSyear()."' AND SCHOOL_ID='".UserSchool()."'");
		break;
