...
//    DrawHeader('<IMG SRC=assets/check.png>'.sprintf(_('The data have been copied to a new school called "%s".'),$_REQUEST['title']),'<INPUT type=submit value="'._('OK').'>"');
	echo ErrorMessage(array('<IMG SRC="assets/check.png" class="alignImg" />&nbsp;'.sprintf(_('The data have been copied to a new school called "%s".'),$_REQUEST['title']).SubmitButton(_('OK'))), 'note');
	echo '</FORM>';
