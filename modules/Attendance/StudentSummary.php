...
{
	$colors = array('P'=>'#FFCC00','A'=>'#FF0000','H'=>'#FFCC00','T'=>'#0000FF');
	return '<TABLE class="cellspacing-0"><TR><TD'.($colors[$state_code]?' style="background-color:'.$colors[$state_code].';"':'').'>'.$value.'</TD></TR></TABLE>';
}
?>