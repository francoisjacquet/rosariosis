...
ORDER BY DATE DESC", [ 'START_DATE' => 'ProperDate', 'END_DATE' => 'ProperDate' ] );

$columns = [ 'FULL_NAME' => _( 'Student' ), 'STUDENT_ID' => sprintf( _( '%s ID' ), Config( 'NAME' ) ), 'COURSE_TITLE' => _( 'Course' ), 'TITLE' => _( 'Course Period' ), 'START_DATE' => _( 'Enrolled' ), 'END_DATE' => _( 'Dropped' ) ];
