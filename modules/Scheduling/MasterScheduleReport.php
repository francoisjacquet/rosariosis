<?php
	...
	$sections_RET = DBGet(DBQuery("SELECT cs.TITLE as SUBJECT_TITLE,c.TITLE AS COURSE,cp.COURSE_ID,cpsp.PERIOD_ID,cp.TEACHER_ID,cp.ROOM,cp.TOTAL_SEATS AS SEATS,cp.MARKING_PERIOD_ID 
	...
	ORDER BY SUBJECT_TITLE, COURSE, cpsp.PERIOD_ID"),array('PERIOD_ID'=>'GetPeriod','TEACHER_ID'=>'GetTeacher','MARKING_PERIOD_ID'=>'_makeMP'),array('COURSE'));
