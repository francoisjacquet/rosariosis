...
- `$RosarioURL` URL qui pointe sur l'instance de RosarioSIS. Définie automatiquement lors de la première connexion. Mettre à jour après une migration de domaine ou après passage du site de http à https.
