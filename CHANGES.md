...
- Add "Credit Food Service Account on Lunch Payment" config option in Configuration.js, Configuration.php, MassAssignPayments.php & StudentPayments.php
...
- Use DBInsert() & DBUpdate() functions (Moodle plugin) in ImportUsers.fnc.php, Student.php, User.php, CreateParents.php, Calendar.php, Courses.php, Assignments.php, Rollover.php & functions.php
...
- Spanish translation: do not capitalize words & use "tú" instead of "usted" in rosariosis.po, help.po & rosariosis.sql
