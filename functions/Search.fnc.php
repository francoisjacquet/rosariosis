		...
		case 'student_id':
			if($_REQUEST['bottom_back'])
			{
				...
				if (mb_strpos($modname,'Search.php')===false)
					echo '<script type="text/javascript">var menu_link = document.createElement("a"); menu_link.href = "'.$_SESSION['Side_PHP_SELF'].'?modname='.rawurlencode($modname).'"; menu_link.target = "menu"; ajaxLink(menu_link);</script>';
			}
