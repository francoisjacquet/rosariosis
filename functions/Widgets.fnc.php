...
//modif Francois: css WPadmin
					$extra['search'] .= '<TR><TD colspan="2">&nbsp;<A onclick="switchMenu(\'enrollment_table\'); return false;" href="#"><IMG SRC="assets/arrow_right.gif" id="enrollment_table_arrow" height="12"> <B>'._('Enrollment').'</B></A>
					<BR />
					<TABLE id="enrollment_table" class="widefat width-100p cellspacing-0 col1-align-right hide">';
				...
				{
					$extra['search'] .= '<TR><TD colspan="2">&nbsp;<A onclick="switchMenu(\'scheduling_table\'); return false;" href="#"><IMG SRC="assets/arrow_right.gif" id="scheduling_table_arrow" height="12"> <B>'._('Scheduling').'</B></A>
					<BR />
					<TABLE id="scheduling_table" class="widefat width-100p cellspacing-0 col1-align-right hide">';
				...
				{
					$extra['search'] .= '<TR><TD colspan="2">&nbsp;<A onclick="switchMenu(\'absences_table\'); return false;" href="#"><IMG SRC="assets/arrow_right.gif" id="absences_table_arrow" height="12"> <B>'._('Attendance').'</B></A>
					<BR />
					<TABLE id="absences_table" class="widefat width-100p cellspacing-0 col1-align-right hide">';
				...
				{
					$extra['search'] .= '<TR><TD colspan="2">&nbsp;<A onclick="switchMenu(\'grades_table\'); return false;" href="#"><IMG SRC="assets/arrow_right.gif" id="grades_table_arrow" height="12"> <B>'._('Grades').'</B></A>
					<BR />
					<TABLE id="grades_table" class="widefat width-100p cellspacing-0 col1-align-right hide">';
				...
				{
					$extra['search'] .= '<TR><TD colspan="2">&nbsp;<A onclick="switchMenu(\'eligibility_table\'); return false;" href="#"><IMG SRC="assets/arrow_right.gif" id="eligibility_table_arrow" height="12"> <B>'._('Eligibility').'</B></A>
					<BR />
					<TABLE id="eligibility_table" class="widefat width-100p cellspacing-0 col1-align-right hide">';
				...
				{
					$extra['search'] .= '<TR><TD colspan="2">&nbsp;<A onclick="switchMenu(\'billing_table\'); return false;" href="#"><IMG SRC="assets/arrow_right.gif" id="billing_table_arrow" height="12"> <B>'._('Student Billing').'</B></A>
					<BR />
					<TABLE id="billing_table" class="widefat width-100p cellspacing-0 col1-align-right hide">';
			...
			case 'course':
				...
				<DIV id="course_div"></DIV> <A HREF="#" onclick=\'window.open("Modules.php?modname=misc/ChooseCourse.php","","scrollbars=yes,resizable=yes,width=800,height=400"); return false;\'>'._('Choose').'</A>
				</TD></TR>';
				}
			break;
			...
			case 'request':
				...
				<DIV id="request_div"></DIV> <A HREF="#" onclick=\'window.open("Modules.php?modname=misc/ChooseRequest.php","","scrollbars=yes,resizable=yes,width=800,height=400");\'>'._('Choose').'</A>
				</TD></TR>';
				}
			break;
			...
			case 'gpa':
				...
				.(GetMP($MPsem = GetParentMP('SEM',UserMP()),'DOES_GRADES') == 'Y'?'<label><INPUT type="radio" name="gpa_term" value="'.$MPsem.'">&nbsp;'.GetMP($MPsem,'SHORT_NAME').'</label> &nbsp;':'').(GetMP($MPtrim = UserMP(),'DOES_GRADES') == 'Y'?'<label><INPUT type="radio" name="gpa_term" value="'.$MPtrim.'" checked />&nbsp;'.GetMP($MPtrim,'SHORT_NAME').'</label>':'').'
				</TD>';

				$extra['search'] .= '<TD>
				'._('Between').' <INPUT type="text" name="gpa_low" size="3" maxlength="5"> &amp; <INPUT type="text" name="gpa_high" size="3" maxlength="5">
				</TD></TR>';
				}
			break;
			...
			case 'class_rank':
				...
				'._('Class Rank').'
				<BR />
				'.(GetMP($MPfy = GetParentMP('FY',GetParentMP('SEM',UserMP())),'DOES_GRADES') == 'Y'?'<label><INPUT type="radio" name="class_rank_term" value="'.$MPfy.'">&nbsp;'.GetMP($MPfy,'SHORT_NAME').'</label>&nbsp; ':'')
				.(GetMP($MPsem = GetParentMP('SEM',UserMP()),'DOES_GRADES') == 'Y'?'<label><INPUT type="radio" name="class_rank_term" value="'.$MPsem.'">&nbsp;'.GetMP($MPsem,'SHORT_NAME').'</label> &nbsp; ':'').(GetMP($MPtrim = UserMP(),'DOES_GRADES') == 'Y'?'<label><INPUT type="radio" name="class_rank_term" value="'.$MPtrim.'" checked />&nbsp;'.GetMP($MPtrim,'SHORT_NAME').'</label>':'');
				...
				$extra['search'] .= '</TD><TD>
				'._('Between').' <INPUT type="text" name="class_rank_low" size="3" maxlength="5"> &amp; <INPUT type="text" name="class_rank_high" size="3" maxlength="5">
				</TD></TR>';
				}
			break;
			...
			case 'eligibility':
				...
				<label><INPUT type="checkbox" name="ineligible" value="Y">&nbsp;'._('Ineligible').'</label>
				</TD></TR>';
				}
			break;
			...
			case 'mailing_labels':
				...
				$extra['search'] .= '<TR><TD style="text-align:right"><label>'._('Mailing Labels').'&nbsp;<INPUT type="checkbox" name="mailing_labels" value="Y"></label></TD>';
			break;

			case 'balance':
				if($RosarioModules['Student_Billing'] && AllowUse('Student_Billing/StudentFees.php'))
				{
			...
			case 'discipline':
				...
				<SELECT name="discipline_reporter"><OPTION value="">'._('Not Specified').'</OPTION>';
				...
				foreach($categories_RET as $category)
				{
					if($category['DATA_TYPE']!='date')
					{
						...
						switch($category['DATA_TYPE'])
						{
							...
							case 'numeric':
								$extra['search'] .= _('Between').' <INPUT type="text" name="discipline_begin['.$category['ID'].']" size="3" maxlength="11" /> & <INPUT type="text" name="discipline_end['.$category['ID'].']" size="3" maxlength="11" />';
			...
			case 'next_year':
				...
				<SELECT name="next_year"><OPTION value="">'._('N/A').'</OPTION>
				<OPTION value="!">'._('No Value').'</OPTION>
				<OPTION value="'.UserSchool().'">'._('Next grade at current school').'</OPTION>
				<OPTION value="0">'._('Retain').'</OPTION>
				<OPTION value="-1">'._('Do not enroll after this school year').'</OPTION>';
			...
			case 'calendar':
				...
				<label><INPUT type="checkbox" name="calendar_not" value="Y"> '._('Not').' </label>
				<SELECT name="calendar"><OPTION value="">'._('N/A').'</OPTION>
				<OPTION value="!">'._('No Value').'</OPTION>';
			...
			case 'rolled':
				...
				<label><INPUT type="radio" value="" name="rolled" checked /> '._('N/A').'</label> &nbsp;
				<label><INPUT type="radio" value="Y" name="rolled"> '._('Yes').'</label> &nbsp;
				<label><INPUT type="radio" value="N" name="rolled"> '._('No').'</label>
				</TD></TR>';
				}
			break;
			...
			case 'fsa_balance':
				...
				<INPUT type="text" name="fsa_balance" size=10'.($value?' value="'.$value.'"':'').'></label>
				</td></tr><tr><td>
			...
			case 'fsa_discount':
				...
				<SELECT name="fsa_discount"><OPTION value="">'._('Not Specified').'</OPTION>
				<OPTION value="Full">'._('Full').'</OPTION>
				<OPTION value="Reduced">'._('Reduced').'</OPTION>
				<OPTION value="Free">'._('Free').'</OPTION></SELECT>
				</TD></TR>';
				}
			break;
			...
			case 'fsa_status':
				...
				<SELECT name=fsa_status><OPTION value="">'._('Not Specified').'</OPTION>
				...
				<OPTION value="Closed">'._('Closed').'</OPTION></SELECT>
				</TD></TR>';
				}
			break;
