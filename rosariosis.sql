...
INSERT INTO config VALUES (0, 'VERSION', '9.2.2');
...
INSERT INTO config VALUES (0, 'DISPLAY_NAME', 'CONCAT(FIRST_NAME,coalesce(CONCAT('' '',MIDDLE_NAME,'' ''),'' ''),LAST_NAME)');
INSERT INTO config VALUES (1, 'DISPLAY_NAME', 'CONCAT(FIRST_NAME,coalesce(CONCAT('' '',MIDDLE_NAME,'' ''),'' ''),LAST_NAME)');
