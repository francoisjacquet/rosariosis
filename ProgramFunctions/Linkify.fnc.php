 ...
 * http://stackoverflow.com/questions/15928606/php-converting-text-links-to-anchor-tags
...
function Linkify($text)
{
	...
	return preg_replace_callback("#$pattern#i", function($matches)
	{
		...
		if (mb_strlen($input) > 100 && !mb_strpos($input, " "))
		{
			$separator = '...';
			$maxlength = 97; //100 - $separator length
			$input = substr_replace($input, $separator, ($maxlength / 2), (mb_strlen($input) - $maxlength));
		}
